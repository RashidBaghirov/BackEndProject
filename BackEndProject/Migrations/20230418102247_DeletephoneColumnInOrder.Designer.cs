...
namespace BackEndProject.Migrations
{
    ...
    [Migration("20230418102247_DeletephoneColumnInOrder")]
    partial class DeletephoneColumnInOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEndProject.Entities.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEndProject.Entities.BasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEndProject.Entities.WishListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEndProject.Entities.BasketItem", b =>
                {
                    b.HasOne("BackEndProject.Entities.Basket", "Basket")
            ...
            modelBuilder.Entity("BackEndProject.Entities.Order", b =>
                {
                    b.HasOne("BackEndProject.Entities.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("BackEndProject.Entities.Order", "BasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BackEndProject.Entities.Product", b =>
                {
                    ...
                    b.HasOne("BackEndProject.Entities.GlobalTab", "GlobalTab")
                        .WithMany("Products")
